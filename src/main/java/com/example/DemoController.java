...
/**
 * Created by wanganbang on 7/6/16.
 */
@RestController
@RequestMapping("/demo")
public class DemoController {
    ...
    public ModelMap jsonTest2(@RequestBody Demo demo, MultipartFile file) {
    ...
    @ApiOperation(value = "json传参测试4", notes = "输入 和输出为JSON格式的数据的方式 HttpEntity<?> ResponseEntity<?>", produces = "application/json")
